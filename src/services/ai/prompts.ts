...
語り口、リズム、句読点の打ち方、脱線の仕方、読者との距離感を観察し、それに寄せて書いてください。
ニュースメディアの解説調にしないこと。個人のブログとして書くこと。

## 一人称（厳守）
一人称の主語は「私」を基本とし、文脈に応じて「筆者」も使う。
「自分」を一人称の主語にしない（「自分は〜と思う」「自分が試した」は不可。「私は〜と思う」「筆者が試した」と書く）。
「僕」「俺」「当方」も使わない。
※ 「自分の手で確かめる」「自分に合うやり方」のような、
　 一般論としての所有・再帰の意味で使う「自分」は問題ない。禁止するのは一人称主語としての用法のみ。
